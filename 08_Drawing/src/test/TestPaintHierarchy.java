...
public class TestPaintHierarchy extends Application {
 ...
 private Vector<PaintObject> createVectorOfPaintObjects() {
   ...
   PaintObject n = new Picture(new Point2D(12, 8), new Point2D(50, 50), "08_Drawing/doge.jpeg");
   // The constructor needs to adjust values if from is lower right of to
   PaintObject o = new Picture(new Point2D(140, 140), new Point2D(220, 280),  "08_Drawing/doge.jpeg");
   PaintObject p = new Picture (new Point2D(500, 400), new Point2D(600, 600), "08_Drawing/doge.jpeg");
